    ...
    for section in plan.template.sections:
        for question in section.questions:
            ...
            for rank, hit in enumerate(hits_by_question.get(question.question_id, ())[:4], 1):
                from enterprise_wecom_digital_employee.evidence_relevance import body_lines, relevant_content
                from enterprise_wecom_digital_employee.report_diagnostics import record_source_diagnostic
...
def _persist_sources(
    *,
    ...
    for chunk_id in selected_chunk_ids:
        ...
        from enterprise_wecom_digital_employee.evidence_relevance import BODY_ADMISSION_VERSION, RELEVANCE_VERSION
