...
from {{ cookiecutter.project_slug }}.mcp_compat import OA_SERVERS, effective_schema
...
def production_service_tools():
    from {{ cookiecutter.project_slug }}.capability_catalog import configured_mcp_server_names
...
async def _describe_oa_query(query_type: OAQuery, runtime: ToolRuntime) -> str:
    from {{ cookiecutter.project_slug }}.tools import Client, _mcp_policy, _normalize_server_config, _read_mcp_servers
