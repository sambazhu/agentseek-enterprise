...
from {{ cookiecutter.project_slug }}.report_artifact import (
...
from {{ cookiecutter.project_slug }}.settings import PROJECT_ROOT, ProjectSettings, get_settings
    ...
    def confirm_report_outline(
        ...
        *,
        ...
        if current.status is WorkContractStatus.CONFIRMED:
            ...
            from {{ cookiecutter.project_slug }}.work_commands import requests_automatic_draft
